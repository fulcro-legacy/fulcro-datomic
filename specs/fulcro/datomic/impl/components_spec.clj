(ns fulcro.datomic.impl.components-spec
  (:require [com.stuartsierra.component :as component]
            ...
            [fulcro.datomic.impl.components :as comp]
...
(t/use-fixtures
  :once #(timbre/with-merged-config
           {:ns-blacklist ["fulcro.datomic.impl.components"]}
           (%)))
...
(specification "DatabaseComponent"
  ...
  (behavior "implements Database"
    (assertions
      (satisfies? fulcro.datomic.protocols/Database (build-database "a-db-name")) => true))
